...
# down side will always predict eventhough the test is not in train
...
test_image_path = input("Enter test image = ")

exists = os.path.isfile(test_image_path)
if exists:
    test_image = face_recognition.load_image_file(test_image_path)
else:
    print(f"{test_image_path} not found")
    exit()
